...
$config['insert-con-ok']   = 'Conteudo criado com sucesso!';
$config['update-con-ok']   = 'Conteudo atualizado com sucesso!';
$config['delete-con-ok']   = 'Conteudo removido com sucesso!';
